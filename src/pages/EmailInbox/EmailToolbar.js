...
const EmailToolbar = () => {
    ...
    const selectLayoutState = (state) => state.Mailbox;                                                                                                                                                                                                                                                                                                                                                                                                         
    const selectLayoutProperties = createSelector                                                                                                                                                                                                                                                                                                                                                                                                           (
        selectLayoutState,
        (layout) => ({
            mailDetails: layout.mailDetails,
             isLoader: layout.isLoader,           
        })
      );
                                    ...
                                    <Row>
                                        ...
                                        <Col className="col-auto">
                                            <UncontrolledButtonDropdown>
                                                <Button color="success" className="btn-sm" onClick={(e) => e.preventDefault()}><i className="ri-send-plane-2-fill align-bottom" /></Button>
                                                <DropdownToggle tag="button" className="btn btn-success btn-sm" split onClick={(e) => e.preventDefault()}>
                                                </DropdownToggle>
                                                <DropdownMenu >
