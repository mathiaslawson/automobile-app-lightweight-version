...
const VehicleTrades = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      trade_id: (contact && contact.pricing_id) || "",
      customer_id: (contact && contact.vehicle_id) || "",
      tenant_id_from: (contact && contact.pricing_tier_id) || "",
      tenant_id_to: (contact && contact.price) || "",
      vehicle_id_from: (contact && contact.vehicle_id_from) || "",
      vehicle_id_to: (contact && contact.vehicle_id_to) || "",
      trade_date: (contact && contact.vehicle_id_to) || "",
      notes: (contact && contact.vehicle_id_to) || "",
    },
    validationSchema: Yup.object({
      trade_id: Yup.string().required("This field should not be empt"),
      customer_id: Yup.string().required("This field should not be empt"),
      tenant_id_from: Yup.string().required("This field should not be empt"),
      tenant_id_to: Yup.number().required("This field should not be empty"),

      vehicle_id_from: Yup.string().required("Please provide vehicle"),
      vehicle_id_to: Yup.string().required("Please provide vehicle"),
      trade_date: Yup.string().required("Please provide trade date"),
  ...
  const users = [
    {
      ...
      cost: "300",
      job: "Maintenance",
      trade_to: "Junction Mechanics",
      vehicle_from: "Camry 91 Model",
      vehicle_to: "BMW m5 Competetion",
    },
    {
      customer: "John Doe",
      created_at: "2023-11-30T02:33:41.023Z",
          ...
          <Row>
            ...
            <Col xxl={8}>
              ...
              >
                ...
                >
                  <div>
                    <MechanicDashboard user={user?.role} />
                  </div>
                </CardBody>
              </Card>
            </Col>
                      ...
                      >
                        ...
                        <div className="text-center mt-5">
                          <p className="text-dark fw-bolder">
                            {!!isEdit
                              ? "Update Vehicle Trade"
                              : "Create Vehicle Trade"}
                          </p>
                        </div>
                                ...
                                <Col className="mt-4" lg={12}>
                                  ...
                                  <Select
                                    ...
                                    value={dealerOptions.find(function (e) {
                                      return (
                                        (!isEdit ? e.label : e.value) ===
                                        validation.values.pricing_tier_id
                                      );
                                    })}
                                    onChange={(e) =>
                                      validation.setFieldValue(
                                  ...
                                  ></Select>
                                  <p style={{ color: "red" }} className="mt-2">
                                    {validation.errors.pricing_tier_id}
                                  </p>
                                </Col>
                                <Col className="mt-4" lg={12}>
                                  <p className=" mb-2">
                                ...
                                <Col lg={12}>
                                  <div>
                                    ...
                                    <Input
                                      ...
                                      value={validation.values.trade_date || ""}
                                      invalid={
                                        validation.touched.trade_date &&
                                        validation.errors.trade_date
                                          ? true
                                          : false
                                      }
                                    />
