...
import RepairEvent from "./RepairEvent";
...
const Tracking = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      invoice_id: (contact && contact.destination_outlet_id) || "",
              ...
              <Col xl={12}>
                <div className="mt-4">
                  <Nav tabs  style={{backgroundColor: 'white', borderRadius: '40px', overflow: 'hidden', border: '1px solid #e0e0e0'}} className="p-2">
                    ...
                    {/* <NavItem className="">
                      <NavLink
                        ...
                        onClick={() => toggleTab("createvehicleevent")}
                      >
                    ...
                    <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "sellvehicleevent",
                        })}
                        onClick={() => toggleTab("sellvehicleevent")}
                      >
                      Sell Vehicle Event
                      </NavLink>
                    </NavItem>
                    <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "repairvehicleevent",
                        })}
                        onClick={() => toggleTab("repairvehicleevent")}
                      >
                    ...
                    <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "tradevehicleevent",
                        })}
                        onClick={() => toggleTab("tradevehicleevent")}
                      >
                      Trade Vehicle Event
                      </NavLink>
                    </NavItem> */}
                    {/* <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "maintenancerecords",
                        })}
                  ...
                  <TabContent activeTab={activeTab}>
                    ...
                    <TabPane tabId="createvehicleevent">
                      <div className="tab-content">
                     <CreateEvent />
                      </div>
                    </TabPane>
                    <TabPane tabId="sellvehicleevent">
                      <div className="tab-content">
                     <SellEvent />
                      </div>
                    </TabPane>
                    <TabPane tabId="repairvehicleevent">
                      <div className="tab-content">
                     <RepairEvent />
                      </div>
                    </TabPane>
                    <TabPane tabId="tradevehicleevent">
                      <div className="tab-content">
                     <TradeEvent />
                      </div>
                    </TabPane>
