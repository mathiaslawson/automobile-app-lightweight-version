...
import RatingComponent from "../RateComponent";
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (contact) => (
          <>
            <RatingComponent totalStars={5} defaultValue={4}/>
          </>
        ),
      },
    //   {
                  ...
                  <div className="table-responsive table-card">
                    ...
                    <div className="p-3">
                      <div className="text-center">
                        ...
                        <img
                          src="https://media.istockphoto.com/id/997890484/video/five-golden-stars-appear-on-the-black-relief-surface.jpg?s=640x640&k=20&c=zei1rZbLfvChxeFNQnvqzCaT2y7yz6Ic9Ex43VvEi3c="
                          alt="fuel"
                          width="200"
                          className="mb-4"
                          style={{
                      ...
                      >
                       ...
                       Elevate user engagement and feedback with our streamlined user rating system. Seamlessly create and customize user rating profiles, enabling you to capture valuable insights and feedback. Our intuitive interface simplifies the process, ensuring efficient tracking and organization of user ratings. Empower your platform with the ability to effortlessly collect, analyze, and respond to user ratings, enhancing user satisfaction and driving continuous improvement. With our user-friendly module, strengthen your relationship with your users by facilitating transparent communication and fostering trust and loyalty.
                      </p>
                    </div>
                  </div>
                </CardBody>
