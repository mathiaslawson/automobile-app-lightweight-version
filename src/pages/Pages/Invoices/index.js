...
import InvoicePayments from "./InvoicePayment";
                ...
                <div className="mt-4">
                  <Nav tabs  style={{backgroundColor: 'white', borderRadius: '40px', overflow: 'hidden', border: '1px solid #e0e0e0'}} className="p-2">
                    ...
                    <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "invoiceitems",
                        })}
                        onClick={() => toggleTab("invoiceitems")}
                      >
                        Invoice Items
                      </NavLink>
                    </NavItem>
                    <NavItem className="">
                      <NavLink
                        className={classnames("custom-tab", {
                          active: activeTab === "invoicepayments",
                        })}
                        onClick={() => toggleTab("invoicepayments")}
                      >
                        Invoice Payments
                      </NavLink>
                    </NavItem>
                  ...
                  <TabContent activeTab={activeTab}>
                    ...
                    <TabPane tabId="invoiceitems">
                      <div className="tab-content">
                        <InvoiceItems />
                      </div>
                    </TabPane>
                    <TabPane tabId="invoicepayments">
                      <div className="tab-content">
                        <InvoicePayments />
                      </div>
                    </TabPane>
