...
const InvoicePayments = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      amount: (contact && contact.description) || "",
      payment_method: (contact && contact.quantity) || "",
      transaction_reference: (contact && contact.unit_price) || "",
    },
    validationSchema: Yup.object({
      invoice_id: Yup.string().required("This field should not be empty"),
      amount: Yup.string().required("This field should not be empty"),
      payment_method: Yup.string().required("This field should not be empty"),
                  ...
                  <div className="table-responsive table-card">
                    ...
                    <div className="p-3">
                      ...
                      >
                        ...
                        Simplify your financial transactions with our platform's streamlined invoice payment management. Effortlessly record, organize, and track payments, ensuring accurate documentation of financial transactions. Our user-friendly interface facilitates efficient payment processing, providing a clear overview of outstanding and completed payments. Enhance your financial management and streamline payment tracking by seamlessly handling and documenting invoice payments through our accessible platform.
                      </p>
                    </div>
                  </div>
                </CardBody>
