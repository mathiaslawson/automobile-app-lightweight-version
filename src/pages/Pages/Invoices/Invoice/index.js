...
const Invoice = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      issue_date: (contact && contact.issue_date) || "",
      due_date: (contact && contact.due_date) || "",
      total_amount: (contact && contact.total_amount) || "",
    },
    validationSchema: Yup.object({
      customer_id: Yup.string().required("This field should not be empty"),
      issue_date: Yup.string().required("This field should not be empty"),
      due_date: Yup.string().required("This field should not be empty"),
      total_amount: Yup.string().required("This field should not be empty"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        console.log(contact);
  ...
  const columns = useMemo(
    () => [
...

      {
        ...
        Cell: (contact) => (
          <>
            {handleValidDate(contact.row.original.issue_date)},{" "}
            <small className="text-muted">
              {handleValidTime(contact.row.original.issue_date)}
            </small>
          </>
        ),
      },
      {
        ...
        Cell: (contact) => (
          <>
            {handleValidDate(contact.row.original.due_date)},{" "}
            <small className="text-muted">
              {handleValidTime(contact.row.original.due_date)}
            </small>
          </>
        ),
      },
  ...
  const users = [
    {
      name: "John Doe",
      issue_date: "2023-11-30T02:33:41.023Z",
      due_date: "2023-11-30T02:33:41.023Z",
      amount: 300.0,
    },
    {
      name: "James Doe",
                      ...
                      >
                        ...
                        <div className="text-center mt-5">
                          <p className="text-dark fw-bolder">
                            {!!isEdit ? "Update Invoice" : "Add Invoce"}
                          </p>
                        </div>
                                ...
                                <Col lg={12}>
                                  <div>
                                    ...
                                    <Input
                                      ...
                                      value={validation.values.issue_date || ""}
                                      invalid={
                                        validation.touched.issue_date &&
                  ...
                  <div className="table-responsive table-card">
                    ...
                    <div className="p-3">
                      ...
                      >
                        ...
                        Efficiently manage your invoices with our user-friendly platform. Create, organize, and track invoices seamlessly, ensuring a clear and detailed record of financial transactions. Our intuitive interface simplifies the invoicing process, allowing for easy customization and efficient tracking. Enhance your financial management and streamline invoicing tasks by effortlessly handling and organizing invoices through our accessible platform.
                      </p>
                    </div>
                  </div>
                </CardBody>
