...
const Features = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      feature_name: (contact && contact.type_name) || "",
    },
    validationSchema: Yup.object({
      feature_name: Yup.string().required("Please enter feature name"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        console.log(contact);
  ...
  const users = [
    { category_name: " V8 Engine", created_at: "2023-11-30T02:33:41.023Z" },
    { category_name: " V6 Engine", created_at: "2023-11-30T02:33:41.023Z" },
  ];
                  ...
                  <div>
                    {!loading && users.length > 0 ? (
                      <TableContainer
                        ...
                        SearchPlaceholder="Search for vehicle features..."
                      />
                    ) : loading === true ? (
                      <Loader error={error} />
                    ) : (
                                ...
                                <Col lg={12}>
                                  <div>
                                    ...
                                    <Input
                                      ...
                                      value={
                                        validation.values.feature_name || ""
                                      }
                                      invalid={
                                        validation.touched.feature_name &&
                                        validation.errors.feature_name
                                          ? true
                                          : false
                                      }
                                    />
                  ...
                  <div className="table-responsive table-card">
                    ...
                    <div className="p-3">
                      ...
                      >
                        ...
                        An engine is a mechanical device that converts fuel into
                        mechanical energy, driving motion in vehicles and
                        various machinery. It operates through controlled
                        combustion, propelling pistons to generate power for
                        movement. Engines are essential components in
                        transportation and industrial applications, continuously
                        evolving for improved efficiency and performance.
                      </p>
                    </div>
                  </div>
                </CardBody>
