...
const FuelTypes = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      fuel_name: (contact && contact.type_name) || "",
    },
    validationSchema: Yup.object({
      fuel_name: Yup.string().required("Please enter fuel name"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        console.log(contact);
  ...
  const users = [
    { category_name: " Disel", created_at: "2023-11-30T02:33:41.023Z" },
  ];
                                ...
                                <Col lg={12}>
                                  <div>
                                    ...
                                    <Input
                                      ...
                                      value={validation.values.fuel_name || ""}
                                      invalid={
                                        validation.touched.fuel_name &&
                                        validation.errors.fuel_name
                                          ? true
                                          : false
                                      }
                                    />
