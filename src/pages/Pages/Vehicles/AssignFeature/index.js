...
const AssignFeature = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      feature_id: (contact && contact.feature_id) || "",
      vehicle_id: (contact && contact.feature_id) || "",
    },
    validationSchema: Yup.object({
      feature_id: Yup.string().required("Please Select Feature"),
  ...
  const users = [
    {
      category_name: " BMW m5 Competetion",
      featrue: "V8 Engine",
      created_at: "2023-11-30T02:33:41.023Z",
    },
    {
      category_name: " Audi Rs7 ",
      created_at: "2023-11-30T02:33:41.023Z",
      featrue: "Twin Turbo",
    },
    {
      category_name: " Ferrari La Ferrari",
      created_at: "2023-11-30T02:33:41.023Z",
      featrue: "4.5 Litre Tank",
    },
    {
      category_name: " BMW m8 Competetion",
      created_at: "2023-11-30T02:33:41.023Z",
      featrue: "V8 Engine",
    },
  ];
                            ...
                            <ModalBody>
                              ...
                              <Row className="g-3">
                                ...
                                <Col className="mt-4" lg={12}>
                                  ...
                                  <Select
                                    name="feature_id"
                                    value={featureOptions.find(function (e) {
                                      return (
                                        (!isEdit ? e.label : e.value) ===
                                        validation.values.feature_id
                                      );
                                    })}
                                    onChange={(e) =>
                                      validation.setFieldValue(
