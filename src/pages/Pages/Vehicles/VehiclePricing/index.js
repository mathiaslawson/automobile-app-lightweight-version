...
const VehiclePricing = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      pricing_id: (contact && contact.pricing_id) || "",
      vehicle_id: (contact && contact.vehicle_id) || "",
      pricing_tier_id: (contact && contact.pricing_tier_id) || "",
      price: (contact && contact.price) || "",
      effective_date: (contact && contact.effective_date) || "",
    },
    validationSchema: Yup.object({
      pricing_id: Yup.string().required("Please Select Price"),
      vehicle_id: Yup.string().required("Please provide Make"),
      pricing_tier_id: Yup.string().required("Please provide Pricing"),
      price: Yup.number().required("Please provide Price"),
      effective_date: Yup.string().required("Please provide effective date"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
        console.log(contact);
                              ...
                              <Row className="g-3">
                                ...
                                <Col className="mt-4" lg={12}>
                                  ...
                                  <Select
                                    ...
                                    value={pricingOptions.find(function (e) {
                                      return (
                                        (!isEdit ? e.label : e.value) ===
