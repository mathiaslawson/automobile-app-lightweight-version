...
import CreateRoles from "../pages/Pages/CreateRoles";
import Permissions from "../pages/Pages/SystemAdmin/Permissions";
import AssignPermission from "../pages/Pages/SystemAdmin/AssignPermission";
import Vehicles from "../pages/Pages/Vehicles";
...
const authProtectedRoutes = [
  ...
  { path: "/assignusertopermission", component: <AssignPermission /> },
  ...
  // eslint-disable-next-line react/display-name
  {
    path: "/createroles",
    exact: true,
    component: <Navigate to="/createroles" />,
  },
  { path: "*", component: <Navigate to="/createroles" /> },
];
